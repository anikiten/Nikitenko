...
public :
   ...
   Int_t           NpxlHits2;
   Int_t           NoutLayers2;
   Double_t        eCaloTowers1;
   Double_t        eCaloTowers2;
   ...
   TBranch        *b_Nlayers1;   //!
   TBranch        *b_NpxlHits1;   //!
   TBranch        *b_NoutLayers1;   //!
   TBranch        *b_Nlayers2;   //!
   TBranch        *b_NpxlHits2;   //!
   TBranch        *b_NoutLayers2;   //!
   TBranch        *b_eCaloTowers1;   //!
   TBranch        *b_eCaloTowers2;   //!
...
// The following code should be used if you want this class to access a chain
      ...
      TChain * chain = new TChain("t1","");
       //   chain->Add("/tmp/stepobr/*.root/t1");
       // chain->Add("/tmp/stepobr/1/*.root/t1");
       // chain->Add("/tmp/stepobr/2/*.root/t1");
       chain->Add("/tmp/stepobr/*.root/t1");  
      tree = chain;
#endif // SINGLE_TREE
...
void SinglePionEfficiencyNew::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Nlayers1", &Nlayers1, &b_Nlayers1);
   fChain->SetBranchAddress("NpxlHits1", &NpxlHits1, &b_NpxlHits1);
   fChain->SetBranchAddress("NoutLayers1", &NoutLayers1, &b_NoutLayers1);
   fChain->SetBranchAddress("Nlayers2", &Nlayers2, &b_Nlayers2);
   fChain->SetBranchAddress("NpxlHits2", &NpxlHits2, &b_NpxlHits2);
   fChain->SetBranchAddress("NoutLayers2", &NoutLayers2, &b_NoutLayers2);
   fChain->SetBranchAddress("eCaloTowers1", &eCaloTowers1, &b_eCaloTowers1);
   fChain->SetBranchAddress("eCaloTowers2", &eCaloTowers2, &b_eCaloTowers2);
