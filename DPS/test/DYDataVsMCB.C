...
void Draw()
{
  ...
  */
  ...
  cout <<" ========================== B ============================" << endl;
   ...
   leg->SetFillColor(10);
   leg->AddEntry(hZY,"Stream B, Z inclusive","P");
   leg->AddEntry(hZY2J,"Z+2jets","P");
   leg->AddEntry(hZY2JDeta,"Z+2jets, #eta_{j1}#times#eta_{j2} < 0, #Delta #eta _{j1j2} > 3.5","P");
   leg->Draw();
   // MC
   TFile* file = new TFile("DiMuonMCFall11B_29Feb.root");
   ...
   hM2mu0->Draw("same");
   leg->AddEntry(hM2mu0,"DY MC, after muon selections","L");
   leg->Draw();
   c2->SaveAs("mass_mumu0B.png");
   ...
   hDeta1->SetLineWidth(3);
   hDeta1->Draw("same");
   leg->AddEntry(hDeta0,"DY MC","L");
   leg->AddEntry(hDeta1,"DY MC","L");
   leg->Draw();
   c3->SaveAs("detaj1j2B.png");
   ...
   leg->SetFillColor(10);
   leg->AddEntry(hMjj,"Stream B, two jets, #eta _{j1}#eta _{j2}<0, #Delta#eta>3.5, CJV ","P");
   cout <<" " << endl;
