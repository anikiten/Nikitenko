...
void Draw()
{
  ...
  */
  ...
  cout <<" ========================== A ============================" << endl;
   ...
   leg->SetFillColor(10);
   leg->AddEntry(hDeta0,"Stream A, data: two jets","P");
   leg->AddEntry(hDeta1,"Stream A, data: two jets, #eta _{j1}#eta _{j2}<0 ","P");
   // MC
   TFile* file = new TFile("DiMuonMCFall11A_29Feb.root");
   hDeta0->Scale(scale);
   hDeta0->SetLineStyle(1);
   ...
   leg->SetFillColor(10);
   leg->AddEntry(hMjj,"Stream A, two jets, #eta _{j1}#eta _{j2}<0, #Delta#eta>3.5, CJV ","P");
   cout <<" " << endl;
