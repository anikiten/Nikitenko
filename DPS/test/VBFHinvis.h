...
#ifdef VBFHinvis_cxx
VBFHinvis::VBFHinvis(TTree *tree)
{
...
*/
  if (tree == 0) {
    ...
    //    chain->Add("/vols/cms02/anikiten/SignalMCFall11/DiMuAnalysis_MC_*.root");
...
Int_t VBFHinvis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VBFHinvis::LoadTree(Long64_t entry)
{
...
void VBFHinvis::Init(TTree *tree)
{
...
void VBFHinvis::Show(Long64_t entry)
{
...
Int_t VBFHinvis::Cut(Long64_t entry)
{
