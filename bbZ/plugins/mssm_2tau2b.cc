...
class mssm_2tau2b : public edm::EDAnalyzer {
public:
  explicit mssm_2tau2b(const edm::ParameterSet&);
  ~mssm_2tau2b();
...
void 
//mssm_2tau2b::beginJob(const edm::EventSetup&)
mssm_2tau2b::beginJob()
{
  using namespace edm;
...
//
mssm_2tau2b::mssm_2tau2b(const edm::ParameterSet& iConfig)
...
void
mssm_2tau2b::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
