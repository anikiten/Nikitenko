...
# with command line options: Configuration/GenProduction/python/EightTeV/Hadronizer_TuneZ2star_8TeV_generic_LHE_pythia_cff.py --step GEN --beamspot Realistic8TeVCollision --conditions START50_V13::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN --filein file:MCDBtoEDM_NONE.root -n 1000
...
process.dyanalysis = cms.EDAnalyzer("DYjets",
     HistOutFile = cms.untracked.string('dypowheg.root'),
...
process.analysis_step = cms.Path(process.dyanalysis)
