...
#    only for Spring10 data redigi'ed from the Summer'09 samples
#    TriggerResults = cms.InputTag("TriggerResults","","REDIGI")	
)
...
process.p1 = cms.Path(process.recoJPTJets*process.ak5JPTJetsL2L3*process.myjetplustrack*process.dump)
