...
class JetPlusTrackAnalysis_MC : public edm::EDAnalyzer {
public:
  explicit JetPlusTrackAnalysis_MC(const edm::ParameterSet&);
  ~JetPlusTrackAnalysis_MC();
...
void 
//JetPlusTrackAnalysis_MC::beginJob(const edm::EventSetup&)
JetPlusTrackAnalysis_MC::beginJob()
{
  using namespace edm;
...
void 
JetPlusTrackAnalysis_MC::endJob() {
...
//
JetPlusTrackAnalysis_MC::JetPlusTrackAnalysis_MC(const edm::ParameterSet& iConfig)
...
JetPlusTrackAnalysis_MC::~JetPlusTrackAnalysis_MC()
{
...
void
JetPlusTrackAnalysis_MC::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  ...
  */
  ...
  cout <<" check ! " << endl;
  cout <<" gen jet size = " << genjets->size() << endl;
...
DEFINE_FWK_MODULE(JetPlusTrackAnalysis_MC);
